...
function Clock() {
    ...
    const start = () => {
        ...
        setTimerId(0)
        setInterval(() => {
            setTimerId(prev => prev !== undefined ?prev + 1 : undefined)
        }, 1000)
    ...
    let dateInString =new Intl.DateTimeFormat("ru")
    ...
    const stringDate = dateInString.format(date) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
